...
--			storyboard.gotoScene( "scenes/"..event.target.id, "zoomOutInFade", 400 )
	...
	data[1] = {}
	data[1].title = "Name:\nGary Carroll"
	data[1].subtitle = "Squad No: 1"
	data[1].image = "images/players/gary.jpg"
	data[1].position = "Goalkeeper"
	data[1].caption = "That boy needs therapy"

	data[2] = {}
	data[2].title = "Name:\nFinbar Moran"
	data[2].subtitle = "Squad No: 12"
	data[2].image = "images/players/finbar.jpg"
	data[2].position = "Goalkeeper"
	data[2].caption = "Lie down on the couch"

	data[3] = {}
	data[3].title = "Name:\nPeter Sheridan"
	data[3].subtitle = "Squad No: 23"
	data[3].image = "images/players/peter.jpg"
	data[3].position = "Goalkeeper"
	data[3].caption = "His truancy problem is way out of hand"

	data[4] = {}
	data[4].title = "Name:\nBob Neilon"
	data[4].subtitle = "Squad No: 24"
	data[4].image = "images/players/bob.jpg"
	data[4].position = "Goalkeeper"
	data[4].caption = "Crazy in the coconut!"

	data[5] = {}
	data[5].title = "Name:\nMark Murtagh"
	data[5].subtitle = "Squad No: 25"
	data[5].image = "images/players/mark.jpg"
	data[5].position = "Goalkeeper"
	data[5].caption = "Grab a kazoo, let's have a duel"

	data[6] = {}
	data[6].title = "Name:\nTimmy Jackson"
	data[6].subtitle = "Squad No: 26"
	data[6].image = "images/players/timmy.jpg"
	data[6].position = "Goalkeeper"
	data[6].caption = "Ranagazoo, let's have a tune"
