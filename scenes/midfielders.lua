...
--			storyboard.gotoScene( "scenes/"..event.target.id, "zoomOutInFade", 400 )
	...
	data[1] = {}
	data[1].title = "Name:\nEnda O'Hara"
	data[1].subtitle = "Squad No: 6"
	data[1].image = "images/players/enda.jpg"
	data[1].position = "Midfielder"
	data[1].caption = "Purely psychosomatic"

	data[2] = {}
	data[2].title = "Name:\nDavid Blessington"
	data[2].subtitle = "Squad No: 7"
	data[2].image = "images/players/blessy.jpg"
	data[2].position = "Midfielder"
	data[2].caption = "..is criminally insane!"

	data[3] = {}
	data[3].title = "Name:\nDessie Kiernan"
	data[3].subtitle = "Squad No: 8"
	data[3].image = "images/players/dessie.jpg"
	data[3].position = "Midfielder"
	data[3].caption = "He was white as a sheet"

	data[4] = {}
	data[4].title = "Name:\nGary Carroll"
	data[4].subtitle = "Squad No: 11"
	data[4].image = "images/players/gary.jpg"
	data[4].position = "Midfielder"
	data[4].caption = "And he also made false teeth"

	data[5] = {}
	data[5].title = "Name:\nPeter Sheridan"
	data[5].subtitle = "Squad No: 16"
	data[5].image = "images/players/peter.jpg"
	data[5].position = "Midfielder"
	data[5].caption = "Cowboys! M-M-midgets, the indians.."

	data[6] = {}
	data[6].title = "Name:\nFinbar Moran"
	data[6].subtitle = "Squad No: 17"
	data[6].image = "images/players/finbar.jpg"
	data[6].position = "Midfielder"
	data[6].caption = "Rectangles, to an optometrist.."
