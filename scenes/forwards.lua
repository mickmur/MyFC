...
--			storyboard.gotoScene( "scenes/"..event.target.id, "zoomOutInFade", 400 )
	...
	data[2] = {}
	data[2].title = "Name:\nEnda O'Hara"
	data[2].subtitle = "Squad No: 6"
	data[2].image = "images/players/enda.jpg"
	data[2].position = "Forward"
	data[2].caption = "Purely psychosomatic"

	data[4] = {}
	data[4].title = "Name:\nDavid Blessington"
	data[4].subtitle = "Squad No: 7"
	data[4].image = "images/players/blessy.jpg"
	data[4].position = "Forward"
	data[4].caption = "..is criminally insane!"

	data[1] = {}
	data[1].title = "Name:\nDessie Kiernan"
	data[1].subtitle = "Squad No: 8"
	data[1].image = "images/players/dessie.jpg"
	data[1].position = "Forward"
	data[1].caption = "He was white as a sheet"

	data[5] = {}
	data[5].title = "Name:\nGary Carroll"
	data[5].subtitle = "Squad No: 11"
	data[5].image = "images/players/gary.jpg"
	data[5].position = "Forward"
	data[5].caption = "And he also made false teeth"

	data[6] = {}
	data[6].title = "Name:\nPeter Sheridan"
	data[6].subtitle = "Squad No: 16"
	data[6].image = "images/players/peter.jpg"
	data[6].position = "Forward"
	data[6].caption = "Cowboys! M-M-midgets, the indians.."

	data[3] = {}
	data[3].title = "Name:\nFinbar Moran"
	data[3].subtitle = "Squad No: 17"
	data[3].image = "images/players/finbar.jpg"
	data[3].position = "Forward"
	data[3].caption = "Rectangles, to an optometrist.."
